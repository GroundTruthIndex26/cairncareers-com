    ...
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div className="footer-links">
          ...
          <span className="footer-compare">{t.footer.compare} <a href="/vs/chatgpt">ChatGPT</a> · <a href="/vs/careerwing">CareerWing</a> · <a href="/vs/career-mirror">Career Mirror</a> · <a href="/vs/maketheleap">Make the Leap</a></span>
        </div>
      </div>
    </footer>
  );
