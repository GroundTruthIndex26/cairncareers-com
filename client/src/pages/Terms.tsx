...
export default function Terms() {
  return <LegalLayout
    ...
    sections={[
      ...
      { title: "Refunds, changes, and questions", body: <><p>The <a href="/refunds">Refund Policy</a> states the terms for future subscription plans, and is incorporated into these terms.</p><p>We may update these terms. Material changes will be reflected in the date above and, where appropriate, communicated before they take effect. Questions can be sent to <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a> or through the <a href="/contact">contact page</a>.</p></> },
    ]}
  />;
}
